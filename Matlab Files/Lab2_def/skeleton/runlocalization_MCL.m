...
while 1
    ...
    if (count == 20 ) pause; end
    if (count == 30 ) pause; end
    if (count == 30*2 ) pause; end
    if (count == 30*3 ) pause; end
    if (count == 170) pause; end
    if (count == 175) pause; end
    if (count == 180) pause; end
    if (count == 185) pause; end
    if (count == 190) pause; end
    if (count == 195) pause; end
    if (count == 200) pause; end
    if (count == 300) pause; end
    if (count == 400) pause; end
    if (count == 500) pause; end
    if (count == 600) pause; end
    if (count == 700) pause; end
    if (count == 800) pause; end
    if (count == 900) pause; end
    line = flines{count};
